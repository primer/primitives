...
export default {
  avatar: {
    ...
    childShadow: (theme: any) =>
      `-2px -2px 0 ${alpha(get("scale.white"), 0.8)(theme)}`,
  },
  topicTag: {
    border: "transparent",
  },
  ...
  overlay: {
    shadow: (theme: any) =>
      `0 1px 3px ${alpha(get("scale.black"), 0.12)(theme)}, 0 8px 24px ${alpha(
        get("scale.gray.7"),
        0.12
      )(theme)}`,
  },
  ...
  btn: {
    ...
    insetShadow: (theme: any) =>
      `inset 0 1px 0 ${alpha(get("scale.white"), 0.25)(theme)}`,
    hoverBg: "#f3f4f6",
    ...
    focusShadow: (theme: any) =>
      `0 0 0 3px ${alpha(get("scale.blue.5"), 0.3)(theme)}`,
    shadowActive: (theme: any) =>
      `inset 0 0.15em 0.3em ${alpha(get("scale.black"), 0.15)(theme)}`, // TODO: Deprecate? Not used in Primer CSS
    shadowInputFocus: (theme: any) =>
      `0 0 0 0.2em ${alpha(get("scale.blue.5"), 0.3)(theme)}`, // TODO: Deprecate?
    ...
    primary: {
      ...
      border: get("border.subtle"),
      shadow: (theme: any) =>
        `0 1px 0 ${alpha(get("scale.black"), 0.1)(theme)}`,
      insetShadow: (theme: any) =>
        `inset 0 1px 0 ${alpha(get("scale.white"), 0.03)(theme)}`,
      hoverBg: "#2c974b",
      hoverBorder: get("border.subtle"),
      selectedBg: darken(get("btn.primary.hoverBg"), 0.02),
      selectedShadow: (theme: any) =>
        `inset 0 1px 0 ${alpha(get("scale.green.9"), 0.2)(theme)}`,
      ...
      focusBorder: get("border.subtle"),
      focusShadow: (theme: any) =>
        `0 0 0 3px ${alpha(get("btn.primary.focusBg"), 0.4)(theme)}`,
    ...
    outline: {
      ...
      hoverBorder: get("border.subtle"),
      hoverShadow: (theme: any) =>
        `0 1px 0 ${alpha(get("scale.black"), 0.1)(theme)}`,
      hoverInsetShadow: (theme: any) =>
        `inset 0 1px 0 ${alpha(get("scale.white"), 0.03)(theme)}`,
    ...
    danger: {
      ...
      selectedBorder: get("border.subtle"),
      selectedShadow: (theme: any) =>
        `inset 0 1px 0 ${alpha(get("scale.red.9"), 0.2)(theme)}`,
      disabledText: alpha(get("scale.red.5"), 0.5),
      disabledBg: get("scale.gray.0"),
      disabledCounterBg: alpha(get("scale.red.5"), 0.05),
      focusBorder: get("border.subtle"),
      focusShadow: (theme: any) =>
        `0 0 0 3px ${alpha(get("scale.red.6"), 0.4)(theme)}`,
