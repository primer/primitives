...
export default {
  ...
  overlay: {
    shadow: (theme: any) =>
      `0 0 0 1px ${get("scale.gray.6")(theme)}, 0 16px 32px ${alpha(
        get("scale.black"),
        0.85
      )(theme)}`,
  },
  ...
  btn: {
    ...
    focusShadow: (theme: any) =>
      `0 0 0 3px ${alpha(get("scale.gray.3"), 0.3)(theme)}`,
    shadowActive: (theme: any) =>
      `inset 0 0.15em 0.3em ${alpha(get("scale.black"), 0.15)(theme)}`,
    shadowInputFocus: (theme: any) =>
      `0 0 0 0.2em ${alpha(get("scale.blue.5"), 0.3)(theme)}`,
    ...
    danger: {
      ...
      focusShadow: (theme: any) =>
        `0 0 0 3px ${alpha(get("scale.red.4"), 0.4)(theme)}`,
