...
export default {
  ...
  border: {
    default: (theme: any, HI_KATIE: 'multiple matches') => `var(--borderColor-default, var(--color-border-default, ${get('scale.gray.2')(theme)}))`,
    muted: (theme: any) => `var(--borderColor-muted, var(--color-border-muted, ${lighten(get('scale.gray.2'), 0.03)(theme)}))`,
    subtle: (theme: any, HI_KATIE: 'no matches') => `var(undefined, var(--color-border-subtle, ${alpha(get('scale.black'), 0.15)(theme)}))`
  },
  shadow: {
  ...
  neutral: {
    ...
    emphasis: (theme: any, HI_KATIE: 'no matches') => `var(undefined, var(--color-neutral-emphasis, ${get('scale.gray.5')(theme)}))`,
    muted: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-disabled, var(--color-neutral-muted, ${alpha(get('scale.gray.3'), 0.2)(theme)}))`,
    subtle: (theme: any) => `var(--bgColor-neutral-muted, var(--color-neutral-subtle, ${alpha(get('scale.gray.1'), 0.5)(theme)}))`
  },
  accent: {
    fg: (theme: any, HI_KATIE: 'multiple matches') => `var(--focus-outlineColor, var(--color-accent-fg, ${get('scale.blue.5')(theme)}))`,
  ...
  open: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-open-emphasis, var(--color-open-emphasis, ${get('success.emphasis')(theme)}))`,
