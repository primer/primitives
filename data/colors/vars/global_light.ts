...
export default {
  fg: {
    ...
    subtle: (theme: any) => `var(--fgColor-muted, var(--color-fg-subtle, ${get('scale.gray.5')(theme)}))`,
  ...
  border: {
    ...
    subtle: (theme: any) => `var(--borderColor-muted, var(--color-border-subtle, ${alpha(get('scale.black'), 0.15)(theme)}))`
  },
  shadow: {
  ...
  neutral: {
    ...
    emphasis: (theme: any) => `var(--bgColor-neutral-emphasis, var(--color-neutral-emphasis, ${get('scale.gray.5')(theme)}))`,
    muted: (theme: any) => `var(--borderColor-neutral-muted, var(--color-neutral-muted, ${alpha(get('scale.gray.3'), 0.2)(theme)}))`,
    subtle: (theme: any) => `var(--bgColor-neutral-muted, var(--color-neutral-subtle, ${alpha(get('scale.gray.1'), 0.5)(theme)}))`
  },
  accent: {
    fg: (theme: any) => `var(--fgColor-accent, var(--color-accent-fg, ${get('scale.blue.5')(theme)}))`,
  ...
  primer: {
    fg: {
      disabled: (theme: any) => `var(--fgColor-disabled, var(--color-primer-fg-disabled, ${get('scale.gray.4')(theme)}))`
    },
    canvas: {
      backdrop: (theme: any) => `var(--overlay-backdrop-bgColor, var(--color-primer-fg-canvas-backdrop, ${alpha(get('scale.black'), 0.5)(theme)}))`, // use for modal/dialogs
      sticky: (theme: any) => `var(--color-primer-canvas-sticky, ${alpha(get('scale.white'), 0.95)(theme)})` // use for sticky headers
    },
    border: {
      active: (theme: any) => `var(--underlineNav-borderColor-active, var(--color-primer-border-active, ${get('scale.coral.3')(theme)}))`,
      contrast: (theme: any) => `var(--borderColor-muted, var(--color-primer-border-contrast, ${alpha(get('scale.black'), 0.1)(theme)}))` // use to increase contrast
    },
    shadow: {
      highlight: (theme: any) => `var(--shadow-highlight, var(--color-primer-shadow-highlight, inset 0 1px 0 ${alpha(get('scale.white'), 0.25)(theme)}))`, // top highlight
      inset: (theme: any) => `var(--shadow-inset, var(--color-primer-shadow-inset, inset 0 1px 0 ${alpha(get('scale.gray.2'), 0.2)(theme)}))`, // top inner shadow
    }
  }
}
