...
export default {
  ...
  border: {
    default: (theme: any, HI_KATIE: 'multiple matches') => `var(--borderColor-default, var(--color-border-default, ${get('scale.gray.6')(theme)}))`,
    muted: (theme: any) => `var(--borderColor-muted, var(--color-border-muted, ${get('scale.gray.7')(theme)}))`,
    subtle: (theme: any, HI_KATIE: 'no matches') => `var(undefined, var(--color-border-subtle, ${alpha(get('scale.gray.0'), 0.1)(theme)}))`
  },
  shadow: {
  ...
  neutral: {
    ...
    emphasis: (theme: any, HI_KATIE: 'no matches') => `var(undefined, var(--color-neutral-emphasis, ${get('scale.gray.4')(theme)}))`,
    muted: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-disabled, var(--color-neutral-muted, ${alpha(get('scale.gray.4'), 0.4)(theme)}))`,
  ...
  success: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--control-borderColor-success, var(--color-success-emphasis, ${get('scale.green.5')(theme)}))`,
  ...
  attention: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--control-borderColor-warning, var(--color-attention-emphasis, ${get('scale.yellow.5')(theme)}))`,
  ...
  severe: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-severe-emphasis, var(--color-severe-emphasis, ${get('scale.orange.5')(theme)}))`,
  ...
  danger: {
    fg: (theme: any, HI_KATIE: 'multiple matches') => `var(--control-danger-fgColor-rest, var(--color-danger-fg, ${get('scale.red.4')(theme)}))`,
  ...
  open: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-open-emphasis, var(--color-open-emphasis, ${get('scale.green.5')(theme)}))`,
  ...
  closed: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-closed-emphasis, var(--color-closed-emphasis, ${get('scale.red.5')(theme)}))`,
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-done-emphasis, var(--color-done-emphasis, ${get('scale.purple.5')(theme)}))`,
  ...
  sponsors: {
    ...
    emphasis: (theme: any, HI_KATIE: 'multiple matches') => `var(--bgColor-sponsors-emphasis, var(--color-sponsors-emphasis, ${get('scale.pink.5')(theme)}))`,
  ...
  primer: {
    fg: {
      disabled: (theme: any, HI_KATIE: 'multiple matches') => `var(--control-fgColor-disabled, var(--color-primer-fg-disabled, ${get('scale.gray.5')(theme)}))`
    },
    canvas: {
      backdrop: (theme: any, HI_KATIE: 'no matches') => `var(undefined, var(--color-primer-fg-canvas-backdrop, ${alpha(get('scale.black'), 0.8)(theme)}))`, // use for modal/dialogs
      sticky: (theme: any, HI_KATIE: 'no matches') => `var(undefined, var(--color-primer-fg-canvas-sticky, ${alpha(get('scale.gray.9'), 0.95)(theme)}))` // use for sticky headers
    },
    border: {
