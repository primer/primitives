...
export default {
  fg: {
    ...
    subtle: (theme: any) => `var(--control-fgColor-placeholder, var(--color-fg-subtle, ${get('scale.gray.4')(theme)}))`,
  ...
  border: {
    ...
    subtle: (theme: any) => `var(undefined, var(--color-border-subtle, ${alpha(get('scale.gray.0'), 0.1)(theme)}))`
  },
  shadow: {
  ...
  neutral: {
    ...
    emphasis: (theme: any) => `var(undefined, var(--color-neutral-emphasis, ${get('scale.gray.4')(theme)}))`,
    muted: (theme: any) => `var(--bgColor-disabled, var(--color-neutral-muted, ${alpha(get('scale.gray.4'), 0.4)(theme)}))`,
  ...
  success: {
    ...
    emphasis: (theme: any) => `var(--control-borderColor-success, var(--color-success-emphasis, ${get('scale.green.5')(theme)}))`,
  ...
  danger: {
    fg: (theme: any) => `var(--control-danger-fgColor-rest, var(--color-danger-fg, ${get('scale.red.4')(theme)}))`,
  ...
  primer: {
    fg: {
      disabled: (theme: any) => `var(undefined, var(--color-fg-disabled, ${get('scale.gray.5')(theme)}))`
    },
    canvas: {
      backdrop: (theme: any) => `var(undefined, var(--color-canvas-backdrop, ${alpha(get('scale.black'), 0.8)(theme)}))`, // use for modal/dialogs
      sticky: (theme: any) => `var(undefined, var(--color-canvas-sticky, ${alpha(get('scale.gray.9'), 0.95)(theme)}))` // use for sticky headers
    },
    border: {
      active: (theme: any) => `var(undefined, var(--color-border-active, ${get('scale.coral.3')(theme)}))`,
      contrast: (theme: any) => `var(undefined, var(--color-border-contrast, ${alpha(get('scale.white'), 0.2)(theme)}))` // use to increase contrast
    },
    shadow: {
