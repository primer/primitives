...
export default {
  fg: {
    ...
    subtle: (theme: any) => `var(--fgColor-muted, var(--color-fg-subtle, ${get('scale.gray.4')(theme)}))`,
  ...
  border: {
    default: (theme: any) => `var(--borderColor-default, var(--color-border-default, ${get('scale.gray.6')(theme)}))`,
    muted: (theme: any) => `var(--borderColor-muted, var(--color-border-muted, ${get('scale.gray.7')(theme)}))`,
    subtle: (theme: any) => `var(--borderColor-muted, var(--color-border-subtle, ${alpha(get('scale.gray.0'), 0.1)(theme)}))`
  },
  shadow: {
  ...
  neutral: {
    ...
    emphasis: (theme: any) => `var(--bgColor-neutral-emphasis, var(--color-neutral-emphasis, ${get('scale.gray.4')(theme)}))`,
    muted: (theme: any) => `var(--borderColor-neutral-muted, var(--color-neutral-muted, ${alpha(get('scale.gray.4'), 0.4)(theme)}))`,
  ...
  success: {
    ...
    emphasis: (theme: any) => `var(--bgColor-success-emphasis, var(--color-success-emphasis, ${get('scale.green.5')(theme)}))`,
  ...
  attention: {
    ...
    emphasis: (theme: any) => `var(--bgColor-attention-emphasis, var(--color-attention-emphasis, ${get('scale.yellow.5')(theme)}))`,
  ...
  danger: {
    fg: (theme: any) => `var(--fgColor-danger, var(--color-danger-fg, ${get('scale.red.4')(theme)}))`,
    emphasis: (theme: any) => `var(--borderColor-danger-emphasis, var(--color-danger-emphasis, ${get('scale.red.5')(theme)}))`,
  ...
  open: {
    ...
    emphasis: (theme: any) => `var(--bgColor-open-emphasis, var(--color-open-emphasis, ${get('scale.green.5')(theme)}))`,
  ...
  primer: {
    fg: {
      disabled: (theme: any) => `var(--fgColor-disabled, var(--color-primer-fg-disabled, ${get('scale.gray.5')(theme)}))`
    },
    canvas: {
      backdrop: (theme: any) => `var(--overlay-backdrop-bgColor, var(--color-primer-canvas-backdrop, ${alpha(get('scale.black'), 0.8)(theme)}))`, // use for modal/dialogs
      sticky: (theme: any) => `var(--color-primer-canvas-sticky, ${alpha(get('scale.gray.9'), 0.95)(theme)})` // use for sticky headers
    },
    border: {
      active: (theme: any) => `var(--underlineNav-borderColor-active, var(--color-primer-border-active, ${get('scale.coral.3')(theme)}))`,
      contrast: (theme: any) => `var(--borderColor-muted, var(--color-primer-border-contrast, ${alpha(get('scale.white'), 0.2)(theme)}))` // use to increase contrast
    },
    shadow: {
      highlight: "var(--shadow-highlight, var(--color-primer-shadow-highlight, 0 0 transparent))", // top highlight
      inset: "var(--shadow-inset, var(--color-primer-shadow-inset, 0 0 transparent))", // top inner shadow
    }
  }
}
