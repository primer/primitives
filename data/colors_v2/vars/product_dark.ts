...
export default {
  ...
  codemirror: {
    ...
    activelineBg: get('neutral.muted'),
  ...
  checks: {
    ...
    dropdownHoverBg: get('neutral.muted'),
    dropdownBtnHoverText: get('fg.default'),
    dropdownBtnHoverBg: get('neutral.muted'),
    scrollbarThumbBg: get('neutral.highlighter'),
