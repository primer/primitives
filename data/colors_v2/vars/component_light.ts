...
export default {
  ...
  btn: {
    ...
    primary: {
      ...
      disabledBg: '#94d3a2',
      disabledBorder: get(’border.blend’),
      focusBg: '#2ea44f',
      focusBorder: get(’border.blend’),
    ...
    outline: {
      ...
      selectedBorder: get(’border.blend’),
