...
In those themes green, red and orange are changed to different colors. This allows us to provide color contrast in parts of the UI like the _diffing view_ for people with color vision deficiency (cvd).
