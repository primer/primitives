...
const baseRequirements: ContrastRequirementBlueprint[] = [
  ...
  ['contrast.text', 'borderColor-neutral-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-accent-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-success-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-open-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-danger-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-closed-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-attention-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-severe-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-done-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-upsell-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'borderColor-sponsors-emphasis', 'bgColor-muted'],
