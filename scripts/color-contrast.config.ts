...
const baseRequirements: ContrastRequirementBlueprint[] = [
  ...
  ['contrast.text', 'fgColor-onInverse', 'bgColor-inverse'],
  ...
  ['contrast.border', 'borderColor-neutral-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-accent-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-success-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-open-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-danger-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-closed-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-attention-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-severe-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-done-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-upsell-emphasis', 'bgColor-muted'],
  ...
  ['contrast.border', 'borderColor-sponsors-emphasis', 'bgColor-muted'],
  ...
  ['contrast.text', 'fgColor-onEmphasis', 'bgColor-emphasis'],
  // borders
