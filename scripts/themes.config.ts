...
export const themes: TokenBuildInput[] = [
  {
    ...
    include: [
      ...
      `src/tokens/functional/color/light/presentational-light.json5`,
    ],
  },
  {
  ...
  },
  {
    ...
    include: [`src/tokens/base/color/dark/dark.json5`, `src/tokens/functional/color/dark/presentational-dark.json5`],
  },
  {
    ...
    include: [
      ...
      `src/tokens/functional/color/dark/presentational-dark.json5`,
    ],
  },
  {
