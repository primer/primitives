...
import {PrimerStyleDictionary} from '~build-config/primer-style-dictionary'
import {copyFilesAndFolders} from '~build-config/utilities/copyFilesAndFolders'
import {platformTypeDefinitions} from '~build-config/platforms/typesDefinitions'
import {platformDeprecatedJson} from '~build-config/platforms/deprecatedJson'
import {platformCss} from '~build-config/platforms/css'
import {platformDocJson} from '~build-config/platforms/docJson'
import {platformScss} from '~build-config/platforms/scss'
import {platformJs} from '~build-config/platforms/javascript'
import {platformTs} from '~build-config/platforms/typescript'
import {platformJson} from '~build-config/platforms/json'
