export default {
  ...
  "marketingIcon": {
    "primary": "var(undefined, var(--color-marketing-icon-primary, #91cbff))",
    "secondary": "var(undefined, var(--color-marketing-icon-secondary, #409eff))"
  },
  "diffBlob": {
    "addition": {
    ...
    "deletion": {
      ...
      "fg": "#0a0c10",
      "numBg": "var(undefined, var(--color-diff-blob-addition-deletion-num-bg, rgba(255,106,105,0.3)))",
      ...
      "wordBg": "var(undefined, var(--color-diff-blob-addition-deletion-word-bg, (obj) => (0, get_1.default)(obj, path)))"
    },
    "hunk": {
  ...
  "selectMenu": {
    ...
    "tapHighlight": "var(undefined, var(--color-select-menu-tap-highlight, rgba(82,89,100,0.5)))",
  ...
  "switchTrack": {
    ...
    "disabledBg": "var(--control-checked-bgColor-disabled, var(--color-switch-track-disabled-bg, #272b33))",
    "fg": "#0a0c10",
  ...
  "segmentedControl": {
    ...
    "button": {
      ...
      "hover": {
        "bg": "var(undefined, var(--color-segmented-control-button-hover-bg, #525964))"
      },
      "active": {
        "bg": "var(undefined, var(--color-segmented-control-button-hover-active-bg, #272b33))"
      },
      "selected": {
        "border": "var(undefined, var(--color-segmented-control-button-hover-active-selected-border, #9ea7b3))"
      }
    }
  },
  "treeViewItem": {
