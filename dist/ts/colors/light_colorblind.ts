export default {
  ...
  "btn": {
    ...
    "primary": {
      ...
      "bg": "var(undefined, var(--color-primary-bg, (obj) => (0, get_1.default)(obj, path)))",
      ...
      "shadow": "var(undefined, var(--color-primary-shadow, 0 1px 0 rgba(27,31,36,0.1)))",
      ...
      "selectedBg": "var(undefined, var(--color-primary-selected-bg, hsla(212,92%,43%,1)))",
      "selectedShadow": "var(undefined, var(--color-primary-selected-shadow, inset 0 1px 0 rgba(0,33,85,0.2)))",
      ...
      "counterBg": "var(undefined, var(--color-primary-counter-bg, rgba(0,33,85,0.2)))"
    },
    "outline": {
      ...
      "hoverShadow": "var(undefined, var(--color-outline-hover-shadow, 0 1px 0 rgba(27,31,36,0.1)))",
    ...
    "danger": {
      "text": "var(undefined, var(--color-danger-text, #b35900))",
      "hoverText": "var(undefined, var(--color-danger-hover-text, #ffffff))",
      "hoverBg": "var(undefined, var(--color-danger-hover-bg, #8a4600))",
      ...
      "hoverShadow": "var(undefined, var(--color-danger-hover-shadow, 0 1px 0 rgba(27,31,36,0.1)))",
      ...
      "selectedBg": "var(undefined, var(--color-danger-selected-bg, hsla(30,100%,32%,1)))",
      ...
      "selectedShadow": "var(undefined, var(--color-danger-selected-shadow, inset 0 1px 0 rgba(65,32,0,0.2)))",
      "disabledText": "var(undefined, var(--color-danger-disabled-text, rgba(179,89,0,0.5)))",
      "disabledBg": "var(undefined, var(--color-danger-disabled-bg, #f6f8fa))",
      "disabledCounterBg": "var(undefined, var(--color-danger-disabled-counter-bg, rgba(179,89,0,0.05)))",
      "counterBg": "var(undefined, var(--color-danger-counter-bg, rgba(179,89,0,0.1)))",
      "icon": "var(undefined, var(--color-danger-icon, #b35900))",
      "hoverIcon": "var(undefined, var(--color-danger-hover-icon, #ffffff))",
      "counterFg": "var(undefined, var(--color-danger-counter-fg, #8a4600))",
      "hoverCounterFg": "var(undefined, var(--color-danger-hover-counter-fg, #ffffff))",
      "disabledCounterFg": "var(undefined, var(--color-danger-disabled-counter-fg, rgba(179,89,0,0.5)))"
    },
    "inactive": {
  ...
  "actionListItem": {
    ...
    "danger": {
      "hoverBg": "var(undefined, var(--color-danger-hover-bg, var(--bgColor-danger-muted, var(--color-danger-subtle, rgba(255,245,232,0.64)))))",
