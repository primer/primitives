export default {
  ...
  "diffBlob": {
    "addition": {
      ...
      "fg": "var(undefined, var(--color-diffBlob-addition-fg, (obj) => (0, get_1.default)(obj, path)))",
    ...
    "deletion": {
      ...
      "fg": "var(undefined, var(--color-diffBlob-addition-deletion-fg, (obj) => (0, get_1.default)(obj, path)))",
    ...
    "expander": {
      "icon": "var(undefined, var(--color-diffBlob-addition-deletion-hunk-expander-icon, (obj) => (0, get_1.default)(obj, path)))"
    },
  ...
  "actionListItem": {
    ...
    "danger": {
      "hoverBg": "var(undefined, var(--color-actionListItem-default-danger-hover-bg, var(--bgColor-danger-muted, var(--color-danger-subtle, rgba(255,245,232,0.64)))))",
      ...
      "hoverText": "var(undefined, var(--color-actionListItem-default-danger-hover-text, (obj) => (0, get_1.default)(obj, path)))"
    }
  },
  "switchTrack": {
