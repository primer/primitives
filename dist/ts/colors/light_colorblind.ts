export default {
  ...
  "diffBlob": {
    ...
    "deletion": {
      "numText": "var(undefined, var(--color-diff-blob-addition-deletion-num-text, (obj) => (0, get_1.default)(obj, path)))",
      "fg": "var(undefined, var(--color-diff-blob-addition-deletion-fg, (obj) => (0, get_1.default)(obj, path)))",
    ...
    "expander": {
      "icon": "var(undefined, var(--color-diff-blob-addition-deletion-hunk-expander-icon, (obj) => (0, get_1.default)(obj, path)))"
    },
  ...
  "prettylights": {
    "syntax": {
      ...
      "entityTag": "var(undefined, var(--color-prettylights-syntax-entity-tag, #0550ae))",
      "keyword": "var(undefined, var(--color-prettylights-syntax-keyword, #b35900))",
      "string": "var(undefined, var(--color-prettylights-syntax-string, #0a3069))",
      "variable": "var(undefined, var(--color-prettylights-syntax-variable, #8a4600))",
      "brackethighlighterUnmatched": "var(undefined, var(--color-prettylights-syntax-brackethighlighter-unmatched, #6f3800))",
      "invalidIllegalText": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-text, #f6f8fa))",
      "invalidIllegalBg": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-bg, #6f3800))",
      "carriageReturnText": "var(undefined, var(--color-prettylights-syntax-carriage-return-text, #f6f8fa))",
      "carriageReturnBg": "var(undefined, var(--color-prettylights-syntax-carriage-return-bg, #b35900))",
      "stringRegexp": "var(undefined, var(--color-prettylights-syntax-string-regexp, #0550ae))",
      ...
      "markupDeletedText": "var(undefined, var(--color-prettylights-syntax-markup-deleted-text, #6f3800))",
      "markupDeletedBg": "var(undefined, var(--color-prettylights-syntax-markup-deleted-bg, #fff5e8))",
      "markupInsertedText": "var(undefined, var(--color-prettylights-syntax-markup-inserted-text, #0550ae))",
      "markupInsertedBg": "var(undefined, var(--color-prettylights-syntax-markup-inserted-bg, #ddf4ff))",
      "markupChangedText": "var(undefined, var(--color-prettylights-syntax-markup-changed-text, #8a4600))",
      "markupChangedBg": "var(undefined, var(--color-prettylights-syntax-markup-changed-bg, #ffddb0))",
  ...
  "checks": {
    ...
    "ansi": {
      ...
      "red": "var(undefined, var(--color-checks-ansi-red, #f79939))",
      "redBright": "var(undefined, var(--color-checks-ansi-red-bright, #ffbc6d))",
      "green": "var(undefined, var(--color-checks-ansi-green, #54aeff))",
      "greenBright": "var(undefined, var(--color-checks-ansi-green-bright, #80ccff))",
  ...
  "ansi": {
    ...
    "red": "var(undefined, var(--color-ansi-red, #b35900))",
    "redBright": "var(undefined, var(--color-ansi-red-bright, #8a4600))",
    "green": "var(undefined, var(--color-ansi-green, #0550ae))",
    "greenBright": "var(undefined, var(--color-ansi-green-bright, #0969da))",
  ...
  "btn": {
    ...
    "primary": {
      ...
      "shadow": "var(undefined, var(--color-btn-primary-shadow, 0 1px 0 rgba(27,31,36,0.1)))// HI_KATIE: no matches",
    ...
    "outline": {
      ...
      "hoverShadow": "var(undefined, var(--color-btn-primary-outline-hover-shadow, 0 1px 0 rgba(27,31,36,0.1)))// HI_KATIE: no matches",
    ...
    "danger": {
      "text": "var(undefined, var(--color-btn-primary-outline-danger-text, #b35900))",
      "hoverText": "var(undefined, var(--color-btn-primary-outline-danger-hover-text, #ffffff))",
      "hoverBg": "var(undefined, var(--color-btn-primary-outline-danger-hover-bg, #8a4600))",
      ...
      "hoverShadow": "var(undefined, var(--color-btn-primary-outline-danger-hover-shadow, 0 1px 0 rgba(27,31,36,0.1)))// HI_KATIE: no matches",
      ...
      "selectedBg": "var(undefined, var(--color-btn-primary-outline-danger-selected-bg, hsla(30,100%,32%,1)))",
      ...
      "selectedShadow": "var(undefined, var(--color-btn-primary-outline-danger-selected-shadow, inset 0 1px 0 rgba(65,32,0,0.2)))// HI_KATIE: no matches",
      "disabledText": "var(undefined, var(--color-btn-primary-outline-danger-disabled-text, rgba(179,89,0,0.5)))",
      "disabledBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-bg, #f6f8fa))",
      "disabledCounterBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-bg, rgba(179,89,0,0.05)))",
      "counterBg": "var(undefined, var(--color-btn-primary-outline-danger-counter-bg, rgba(179,89,0,0.1)))",
      "icon": "var(undefined, var(--color-btn-primary-outline-danger-icon, #b35900))",
      "hoverIcon": "var(undefined, var(--color-btn-primary-outline-danger-hover-icon, #ffffff))",
      "counterFg": "var(undefined, var(--color-btn-primary-outline-danger-counter-fg, #8a4600))",
      "hoverCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-hover-counter-fg, #ffffff))",
      "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-fg, rgba(179,89,0,0.5)))"
    },
    "inactive": {
  ...
  "actionListItem": {
    ...
    "danger": {
      "hoverBg": "var(undefined, var(--color-action-list-item-default-danger-hover-bg, var(--bgColor-danger-muted, var(--color-danger-subtle, rgba(255,245,232,0.64)))))",
      ...
      "hoverText": "var(undefined, var(--color-action-list-item-default-danger-hover-text, (obj) => (0, get_1.default)(obj, path)))"
    }
  },
  "switchTrack": {
  ...
  "primer": {
    ...
    "canvas": {
      "backdrop": "var(undefined, var(--color-primer-fg-canvas-backdrop, rgba(27,31,36,0.5)))",
    ...
    "border": {
      ...
      "contrast": "var(undefined, var(--color-primer-fg-canvas-border-contrast, rgba(27,31,36,0.1)))"
    },
    "shadow": {
