export default {
  ...
  "marketingIcon": {
    "primary": "var(undefined, var(--color-marketing-icon-primary, #1168e3))",
    "secondary": "var(undefined, var(--color-marketing-icon-secondary, #368cf9))"
  },
  "diffBlob": {
    "addition": {
  ...
  "prettylights": {
    "syntax": {
      "comment": "var(undefined, var(--color-prettylights-syntax-comment, #4b535d))",
      "constant": "var(undefined, var(--color-prettylights-syntax-constant, #023b95))",
      "entity": "var(undefined, var(--color-prettylights-syntax-entity, #512598))",
      "storageModifierImport": "var(undefined, var(--color-prettylights-syntax-storage-modifier-import, #0e1116))",
      "entityTag": "var(undefined, var(--color-prettylights-syntax-entity-tag, #024c1a))",
      "keyword": "var(undefined, var(--color-prettylights-syntax-keyword, #a0111f))",
      "string": "var(undefined, var(--color-prettylights-syntax-string, #032563))",
      "variable": "var(undefined, var(--color-prettylights-syntax-variable, #702c00))",
      "brackethighlighterUnmatched": "var(undefined, var(--color-prettylights-syntax-brackethighlighter-unmatched, #6e011a))",
      "invalidIllegalText": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-text, #ffffff))",
      "invalidIllegalBg": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-bg, #6e011a))",
      "carriageReturnText": "var(undefined, var(--color-prettylights-syntax-carriage-return-text, #ffffff))",
      "carriageReturnBg": "var(undefined, var(--color-prettylights-syntax-carriage-return-bg, #a0111f))",
      "stringRegexp": "var(undefined, var(--color-prettylights-syntax-string-regexp, #024c1a))",
      "markupList": "var(undefined, var(--color-prettylights-syntax-markup-list, #2e1800))",
      "markupHeading": "var(undefined, var(--color-prettylights-syntax-markup-heading, #023b95))",
      "markupItalic": "var(undefined, var(--color-prettylights-syntax-markup-italic, #0e1116))",
      "markupBold": "var(undefined, var(--color-prettylights-syntax-markup-bold, #0e1116))",
      "markupDeletedText": "var(undefined, var(--color-prettylights-syntax-markup-deleted-text, #6e011a))",
      "markupDeletedBg": "var(undefined, var(--color-prettylights-syntax-markup-deleted-bg, #fff0ee))",
      "markupInsertedText": "var(undefined, var(--color-prettylights-syntax-markup-inserted-text, #024c1a))",
      "markupInsertedBg": "var(undefined, var(--color-prettylights-syntax-markup-inserted-bg, #d2fedb))",
      "markupChangedText": "var(undefined, var(--color-prettylights-syntax-markup-changed-text, #702c00))",
      "markupChangedBg": "var(undefined, var(--color-prettylights-syntax-markup-changed-bg, #ffc67b))",
      "markupIgnoredText": "var(undefined, var(--color-prettylights-syntax-markup-ignored-text, #e7ecf0))",
      "markupIgnoredBg": "var(undefined, var(--color-prettylights-syntax-markup-ignored-bg, #023b95))",
      "metaDiffRange": "var(undefined, var(--color-prettylights-syntax-meta-diff-range, #622cbc))",
      "brackethighlighterAngle": "var(undefined, var(--color-prettylights-syntax-brackethighlighter-angle, #4b535d))",
      "sublimelinterGutterMark": "var(undefined, var(--color-prettylights-syntax-sublimelinter-gutter-mark, #88929d))",
      "constantOtherReferenceLink": "var(undefined, var(--color-prettylights-syntax-constant-other-reference-link, #032563))"
    }
  },
  "codemirror": {
  ...
  "checks": {
    ...
    "ansi": {
      "black": "var(undefined, var(--color-checks-ansi-black, #0e1116))",
      "blackBright": "var(undefined, var(--color-checks-ansi-black-bright, #20252c))",
      "white": "var(undefined, var(--color-checks-ansi-white, #ced5dc))",
      "whiteBright": "var(undefined, var(--color-checks-ansi-white-bright, #ced5dc))",
      "gray": "var(undefined, var(--color-checks-ansi-gray, #88929d))",
      "red": "var(undefined, var(--color-checks-ansi-red, #ee5a5d))",
      "redBright": "var(undefined, var(--color-checks-ansi-red-bright, #ff8e8a))",
      "green": "var(undefined, var(--color-checks-ansi-green, #26a148))",
      "greenBright": "var(undefined, var(--color-checks-ansi-green-bright, #43c663))",
      "yellow": "var(undefined, var(--color-checks-ansi-yellow, #b58407))",
      "yellowBright": "var(undefined, var(--color-checks-ansi-yellow-bright, #d5a824))",
      "blue": "var(undefined, var(--color-checks-ansi-blue, #368cf9))",
      "blueBright": "var(undefined, var(--color-checks-ansi-blue-bright, #67b3fd))",
      "magenta": "var(undefined, var(--color-checks-ansi-magenta, #a371f7))",
      "magentaBright": "var(undefined, var(--color-checks-ansi-magenta-bright, #c49bff))",
  ...
  "selectMenu": {
    ...
    "tapHighlight": "var(undefined, var(--color-select-menu-tap-highlight, rgba(172,182,192,0.5)))",
  ...
  "btn": {
    ...
    "primary": {
      ...
      "bg": "#055d20",
      "border": "#013d14",
      "shadow": "var(undefined, var(--color-btn-primary-shadow, 0 1px 0 rgba(1,4,9,0.1)))// HI_KATIE: no matches",
    ...
    "outline": {
      ...
      "selectedShadow": "var(undefined, var(--color-btn-primary-outline-selected-shadow, inset 0 1px 0 rgba(2,26,74,0.2)))// HI_KATIE: no matches",
      "disabledText": "rgba(3,73,180,0.5)",
      "disabledBg": "#e7ecf0",
      "disabledCounterBg": "var(undefined, var(--color-btn-primary-outline-disabled-counter-bg, rgba(3,73,180,0.05)))",
      "counterBg": "var(undefined, var(--color-btn-primary-outline-counter-bg, #0969da1a))",
      "counterFg": "var(undefined, var(--color-btn-primary-outline-counter-fg, #023b95))",
      "hoverCounterFg": "var(undefined, var(--color-btn-primary-outline-hover-counter-fg, #ffffff))",
      "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-disabled-counter-fg, rgba(3,73,180,0.5)))"
    },
    "danger": {
      "text": "#86061d",
      ...
      "hoverBorder": "#6e011a",
      "hoverShadow": "var(undefined, var(--color-btn-primary-outline-danger-hover-shadow, 0 1px 0 rgba(1,4,9,0.1)))// HI_KATIE: no matches",
      ...
      "selectedShadow": "var(undefined, var(--color-btn-primary-outline-danger-selected-shadow, inset 0 1px 0 rgba(67,0,17,0.2)))// HI_KATIE: no matches",
      "disabledText": "var(undefined, var(--color-btn-primary-outline-danger-disabled-text, rgba(160,17,31,0.5)))",
      "disabledBg": "#e7ecf0",
      "disabledCounterBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-bg, rgba(160,17,31,0.05)))",
      "counterBg": "var(undefined, var(--color-btn-primary-outline-danger-counter-bg, rgba(160,17,31,0.1)))",
      "icon": "#86061d",
      "hoverIcon": "var(undefined, var(--color-btn-primary-outline-danger-hover-icon, #ffffff))",
      "counterFg": "var(undefined, var(--color-btn-primary-outline-danger-counter-fg, #86061d))",
      "hoverCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-hover-counter-fg, #ffffff))",
      "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-fg, rgba(160,17,31,0.5)))"
    },
    "inactive": {
      "bg": "var(undefined, var(--color-btn-primary-outline-danger-inactive-bg, #e7ecf0))",
      "text": "var(undefined, var(--color-btn-primary-outline-danger-inactive-text, #4b535d))"
    }
  },
  "underlinenav": {
  ...
  "switchTrack": {
    ...
    "disabledBg": "var(--control-checked-bgColor-disabled, var(--color-switch-track-disabled-bg, #88929d))",
    "fg": "var(--fgColor-onEmphasis, var(--color-fg-on-emphasis, #ffffff))",
  ...
  "switchKnob": {
    ...
    "disabledBg": "var(undefined, var(--color-switch-knob-disabled-bg, (obj) => (0, get_1.default)(obj, path)))",
    "border": "#20252c",
    "checked": {
      ...
      "disabledBg": "var(undefined, var(--color-switch-knob-checked-disabled-bg, (obj) => (0, get_1.default)(obj, path)))",
      "border": "var(--bgColor-accent-emphasis, var(--color-accent-emphasis, #0349b4))"
    }
  },
  "segmentedControl": {
    "bg": "var(undefined, var(--color-segmented-control-bg, #e7ecf0))",
    "button": {
      ...
      "hover": {
        "bg": "var(undefined, var(--color-segmented-control-button-hover-bg, rgba(172,182,192,0.2)))"
      },
      "active": {
        "bg": "var(undefined, var(--color-segmented-control-button-hover-active-bg, rgba(172,182,192,0.4)))"
      },
      "selected": {
        "border": "var(undefined, var(--color-segmented-control-button-hover-active-selected-border, #88929d))"
      }
    }
  },
  "treeViewItem": {
    ...
    "directory": {
      "fill": "var(undefined, var(--color-tree-view-item-chevron-directory-fill, #368cf9))"
    }
  },
  "fg": {
    "default": "#0e1116",
  ...
  "primer": {
    "fg": {
      "disabled": "var(--control-fgColor-disabled, var(--color-primer-fg-disabled, #88929d))"
    },
    "canvas": {
      "backdrop": "var(undefined, var(--color-primer-fg-canvas-backdrop, rgba(1,4,9,0.5)))",
      "sticky": "var(undefined, var(--color-primer-fg-canvas-sticky, rgba(255,255,255,0.95)))"
    },
    "border": {
      "active": "var(undefined, var(--color-primer-fg-canvas-border-active, #ef5b48))",
      "contrast": "var(undefined, var(--color-primer-fg-canvas-border-contrast, rgba(1,4,9,0.1)))"
    },
    "shadow": {
      ...
      "inset": "var(undefined, var(--color-primer-fg-canvas-border-shadow-inset, inset 0 1px 0 rgba(206,213,220,0.2)))// HI_KATIE: no matches"
    }
  },
  "scale": {
    "black": "#010409",
