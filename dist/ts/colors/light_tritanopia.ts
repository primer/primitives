export default {
  ...
  "diffBlob": {
    ...
    "deletion": {
      ...
      "numBg": "var(--borderColor-danger-muted, var(--color-danger-muted, rgba(255,129,130,0.4)))",
  ...
  "prettylights": {
    "syntax": {
      ...
      "variable": "var(undefined, var(--color-prettylights-syntax-variable, #a40e26))",
      ...
      "markupChangedText": "var(undefined, var(--color-prettylights-syntax-markup-changed-text, #a40e26))",
      "markupChangedBg": "var(undefined, var(--color-prettylights-syntax-markup-changed-bg, #ffcecb))",
