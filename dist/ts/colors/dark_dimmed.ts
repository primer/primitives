export default {
  "canvasDefaultTransparent": "var(undefined, var(--color--canvas-default-transparent, rgba(34,39,46,0)))",
  ...
  "btn": {
    ...
    "danger": {
      ...
      "disabledCounterFg": "var(undefined, var(--color-danger-disabled-counter-fg, rgba(229,83,75,0.5)))",
  ...
  "actionListItem": {
    "inlineDivider": "var(undefined, var(--color-actionListItem-inline-divider, rgba(68,76,86,0.48)))",
    "default": {
  ...
  "switchTrack": {
    ...
    "hoverBg": "var(undefined, var(--color-switchTrack-hover-bg, hsla(213,11%,69%,0.1)))",
