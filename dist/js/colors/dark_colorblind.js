...
exports.default = {
    ...
    "marketingIcon": {
        "primary": "var(undefined, var(--color-marketing-icon-primary, #79c0ff))",
        "secondary": "var(undefined, var(--color-marketing-icon-secondary, #1f6feb))"
    },
    "diffBlob": {
        "addition": {
        ...
        "deletion": {
            ...
            "numBg": "var(undefined, var(--color-diff-blob-addition-deletion-num-bg, rgba(212,118,22,0.3)))",
    ...
    "prettylights": {
        "syntax": {
            ...
            "entityTag": "var(undefined, var(--color-prettylights-syntax-entity-tag, #a5d6ff))",
            "keyword": "var(undefined, var(--color-prettylights-syntax-keyword, #ec8e2c))",
            "string": "var(undefined, var(--color-prettylights-syntax-string, #a5d6ff))",
            "variable": "var(undefined, var(--color-prettylights-syntax-variable, #fdac54))",
            "brackethighlighterUnmatched": "var(undefined, var(--color-prettylights-syntax-brackethighlighter-unmatched, #d47616))",
            "invalidIllegalText": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-text, #f0f6fc))",
            "invalidIllegalBg": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-bg, #6c3906))",
            "carriageReturnText": "var(undefined, var(--color-prettylights-syntax-carriage-return-text, #f0f6fc))",
            "carriageReturnBg": "var(undefined, var(--color-prettylights-syntax-carriage-return-bg, #914d04))",
            "stringRegexp": "var(undefined, var(--color-prettylights-syntax-string-regexp, #a5d6ff))",
            ...
            "markupDeletedText": "var(undefined, var(--color-prettylights-syntax-markup-deleted-text, #ffe2bb))",
            "markupDeletedBg": "var(undefined, var(--color-prettylights-syntax-markup-deleted-bg, #4e2906))",
            "markupInsertedText": "var(undefined, var(--color-prettylights-syntax-markup-inserted-text, #cae8ff))",
            "markupInsertedBg": "var(undefined, var(--color-prettylights-syntax-markup-inserted-bg, #0c2d6b))",
            "markupChangedText": "var(undefined, var(--color-prettylights-syntax-markup-changed-text, #ffe2bb))",
            "markupChangedBg": "var(undefined, var(--color-prettylights-syntax-markup-changed-bg, #4e2906))",
    ...
    "checks": {
        ...
        "ansi": {
            ...
            "red": "var(undefined, var(--color-checks-ansi-red, #ec8e2c))",
            "redBright": "var(undefined, var(--color-checks-ansi-red-bright, #fdac54))",
            "green": "var(undefined, var(--color-checks-ansi-green, #58a6ff))",
            "greenBright": "var(undefined, var(--color-checks-ansi-green-bright, #79c0ff))",
    ...
    "selectMenu": {
        ...
        "tapHighlight": "var(undefined, var(--color-select-menu-tap-highlight, rgba(48,54,61,0.5)))",
    ...
    "btn": {
        ...
        "outline": {
            ...
            "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-disabled-counter-fg, rgba(88,166,255,0.5)))",
            "counterFg": "var(undefined, var(--color-btn-primary-outline-counter-fg, #388bfd))"
        },
        "danger": {
            "text": "var(undefined, var(--color-btn-primary-outline-danger-text, #d47616))",
            ...
            "hoverBg": "var(undefined, var(--color-btn-primary-outline-danger-hover-bg, #b76100))",
            "hoverBorder": "var(undefined, var(--color-btn-primary-outline-danger-hover-border, #d47616))",
            ...
            "selectedBg": "var(undefined, var(--color-btn-primary-outline-danger-selected-bg, #914d04))",
            "selectedBorder": "var(undefined, var(--color-btn-primary-outline-danger-selected-border, #ec8e2c))",
            "selectedShadow": "var(undefined, var(--color-btn-primary-outline-danger-selected-shadow, 0 0 transparent))",
            "disabledText": "var(undefined, var(--color-btn-primary-outline-danger-disabled-text, rgba(212,118,22,0.5)))",
            "disabledBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-bg, #0d1117))",
            "disabledCounterBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-bg, rgba(183,97,0,0.05)))",
            "counterBg": "var(undefined, var(--color-btn-primary-outline-danger-counter-bg, rgba(51,28,4,0.2)))",
            "icon": "var(undefined, var(--color-btn-primary-outline-danger-icon, #d47616))",
            ...
            "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-fg, var(--control-danger-fgColor-rest, var(--color-danger-fg, rgba(212,118,22,0.5)))))",
    ...
    "actionListItem": {
        "inlineDivider": "var(undefined, var(--color-action-list-item-inline-divider, var(--borderColor-default, var(--color-border-default, rgba(48,54,61,0.48)))))",
        "default": {
            ...
            "selectedBg": "var(--control-transparent-bgColor-disabled, var(--color-action-list-item-default-selected-bg, rgba(177,186,196,0.08)))"
        },
        "danger": {
            "hoverBg": "var(undefined, var(--color-action-list-item-default-danger-hover-bg, rgba(212,118,22,0.16)))",
            "activeBg": "var(undefined, var(--color-action-list-item-default-danger-active-bg, rgba(212,118,22,0.24)))",
            "hoverText": "var(undefined, var(--color-action-list-item-default-danger-hover-text, #ec8e2c))"
        }
    },
    "switchTrack": {
        ...
        "disabledBg": "var(--control-checked-bgColor-disabled, var(--color-switch-track-disabled-bg, #21262d))",
    ...
    "segmentedControl": {
        ...
        "button": {
            ...
            "hover": {
                "bg": "var(undefined, var(--color-segmented-control-button-hover-bg, #30363d))"
            },
            "active": {
                "bg": "var(undefined, var(--color-segmented-control-button-hover-active-bg, #21262d))"
            },
            "selected": {
                "border": "var(undefined, var(--color-segmented-control-button-hover-active-selected-border, #6e7681))"
            }
        }
    },
    "treeViewItem": {
        "chevron": {
            "hoverBg": "var(undefined, var(--color-tree-view-item-chevron-hover-bg, rgba(177,186,196,0.12)))"
        },
        "directory": {
    ...
    "danger": {
        "fg": "var(--control-danger-fgColor-rest, var(--color-danger-fg, #d47616))",
        "emphasis": "var(--control-borderColor-danger, var(--color-danger-emphasis, #b76100))",
