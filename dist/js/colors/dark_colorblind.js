...
exports.default = {
    ...
    "diffBlob": {
        "addition": {
            ...
            "numBg": "var(undefined, var(--color-diffBlob-addition-num-bg, rgba(88,166,255,0.3)))",
        ...
        "deletion": {
            ...
            "numBg": "var(undefined, var(--color-diffBlob-addition-deletion-num-bg, rgba(212,118,22,0.3)))",
    ...
    "actionListItem": {
        ...
        "danger": {
            "hoverBg": "var(undefined, var(--color-actionListItem-default-danger-hover-bg, rgba(212,118,22,0.16)))",
            "activeBg": "var(undefined, var(--color-actionListItem-default-danger-active-bg, rgba(212,118,22,0.24)))",
            "hoverText": "var(undefined, var(--color-actionListItem-default-danger-hover-text, #ec8e2c))"
        }
    },
    "switchTrack": {
