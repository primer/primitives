...
exports.default = {
    ...
    "diffBlob": {
        "addition": {
            "numText": "var(undefined, var(--color-diffBlob-addition-num-text, (theme, HI_KATIE) => `var(--control-fgColor-rest, var(--color-fg-default, ${(0, utils_v1_1.get)('scale.black')(theme)}))`))",
            "fg": "var(undefined, var(--color-diffBlob-addition-fg, (theme, HI_KATIE) => `var(--control-fgColor-rest, var(--color-fg-default, ${(0, utils_v1_1.get)('scale.black')(theme)}))`))",
        ...
        "deletion": {
            "numText": "var(undefined, var(--color-diffBlob-addition-deletion-num-text, (theme, HI_KATIE) => `var(--control-fgColor-rest, var(--color-fg-default, ${(0, utils_v1_1.get)('scale.black')(theme)}))`))",
            "fg": "var(undefined, var(--color-diffBlob-addition-deletion-fg, (theme, HI_KATIE) => `var(--control-fgColor-rest, var(--color-fg-default, ${(0, utils_v1_1.get)('scale.black')(theme)}))`))",
            "numBg": "var(undefined, var(--color-diffBlob-addition-deletion-num-bg, #ffd7d5))",
            "lineBg": "var(undefined, var(--color-diffBlob-addition-deletion-line-bg, (theme) => `var(--bgColor-danger-muted, var(--color-danger-subtle, ${(0, utils_v1_1.get)('scale.red.0')(theme)}))`))",
            "wordBg": "var(undefined, var(--color-diffBlob-addition-deletion-word-bg, (theme) => `var(--borderColor-danger-muted, var(--color-danger-muted, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.red.3'), 0.4)(theme)}))`))"
        },
        "hunk": {
            "numBg": "var(undefined, var(--color-diffBlob-addition-deletion-hunk-num-bg, (theme) => `var(--borderColor-accent-muted, var(--color-accent-muted, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.blue.3'), 0.4)(theme)}))`))"
        },
        "expander": {
            "icon": "var(undefined, var(--color-diffBlob-addition-deletion-hunk-expander-icon, var(--control-iconColor-rest, var(--color-fg-muted, #656d76))))"
        },
    ...
    "actionListItem": {
        ...
        "default": {
            "hoverBg": "var(undefined, var(--color-actionListItem-default-hover-bg, rgba(208,215,222,0.32)))",
            "hoverBorder": "var(undefined, var(--color-actionListItem-default-hover-border, transparent))",
            "activeBg": "var(undefined, var(--color-actionListItem-default-active-bg, rgba(208,215,222,0.48)))",
            "activeBorder": "var(undefined, var(--color-actionListItem-default-active-border, transparent))",
            "selectedBg": "var(undefined, var(--color-actionListItem-default-selected-bg, rgba(208,215,222,0.24)))"
        },
        "danger": {
            "hoverBg": "var(undefined, var(--color-actionListItem-default-danger-hover-bg, var(--bgColor-danger-muted, var(--color-danger-subtle, rgba(255,235,233,0.64)))))",
            "activeBg": "var(undefined, var(--color-actionListItem-default-danger-active-bg, (theme) => `var(--bgColor-danger-muted, var(--color-danger-subtle, ${(0, utils_v1_1.get)('scale.red.0')(theme)}))`))",
            "hoverText": "var(undefined, var(--color-actionListItem-default-danger-hover-text, var(--control-danger-fgColor-rest, var(--color-danger-fg, #d1242f))))"
        }
    },
    "switchTrack": {
        ...
        "checked": {
            "bg": "var(undefined, var(--color-switchTrack-checked-bg, (theme, HI_KATIE) => `var(--bgColor-accent-emphasis, var(--color-accent-emphasis, ${(0, utils_v1_1.get)('scale.blue.5')(theme)}))`))",
            "hoverBg": "var(undefined, var(--color-switchTrack-checked-hover-bg, #0860CA))",
            "activeBg": "var(undefined, var(--color-switchTrack-checked-active-bg, #0757BA))",
            ...
            "disabledFg": "var(undefined, var(--color-switchTrack-checked-disabled-fg, (theme) => `var(--fgColor-onEmphasis, var(--color-fg-on-emphasis, ${(0, utils_v1_1.get)('scale.white')(theme)}))`))",
    ...
    "switchKnob": {
        ...
        "checked": {
            "bg": "var(undefined, var(--color-switchKnob-checked-bg, (theme) => `var(--bgColor-default, var(--color-canvas-default, ${(0, utils_v1_1.get)('scale.white')(theme)}))`))",
            "disabledBg": "var(undefined, var(--color-switchKnob-checked-disabled-bg, (theme) => `var(--bgColor-muted, var(--color-canvas-subtle, ${(0, utils_v1_1.get)('scale.gray.0')(theme)}))`))",
            "border": "var(undefined, var(--color-switchKnob-checked-border, (theme, HI_KATIE) => `var(--bgColor-accent-emphasis, var(--color-accent-emphasis, ${(0, utils_v1_1.get)('scale.blue.5')(theme)}))`))"
        }
    },
    "segmentedControl": {
        "bg": "var(undefined, var(--color-segmentedControl-bg, #eaeef2))",
        "button": {
            "bg": "var(undefined, var(--color-segmentedControl-button-bg, (theme) => `var(--bgColor-default, var(--color-canvas-default, ${(0, utils_v1_1.get)('scale.white')(theme)}))`))",
            "hover": {
                "bg": "var(undefined, var(--color-segmentedControl-button-hover-bg, rgba(175,184,193,0.2)))"
            },
            "active": {
                "bg": "var(undefined, var(--color-segmentedControl-button-hover-active-bg, rgba(175,184,193,0.4)))"
            },
            "selected": {
                "border": "var(undefined, var(--color-segmentedControl-button-hover-active-selected-border, #8c959f))"
            }
        }
    },
    "treeViewItem": {
        "chevron": {
            "hoverBg": "var(undefined, var(--color-treeViewItem-chevron-hover-bg, rgba(208,215,222,0.32)))"
        },
        "directory": {
            "fill": "var(undefined, var(--color-treeViewItem-chevron-directory-fill, #54aeff))"
        }
    },
    "fg": {
