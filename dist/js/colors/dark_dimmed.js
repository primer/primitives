...
exports.default = {
    ...
    "diffBlob": {
        "addition": {
            ...
            "numBg": "var(undefined, var(--color-diffBlob-addition-num-bg, rgba(87,171,90,0.3)))",
        ...
        "deletion": {
            ...
            "numBg": "var(undefined, var(--color-diffBlob-addition-deletion-num-bg, rgba(229,83,75,0.3)))",
    ...
    "actionListItem": {
        ...
        "default": {
            "hoverBg": "var(undefined, var(--color-actionListItem-default-hover-bg, rgba(144,157,171,0.12)))",
            "hoverBorder": "var(undefined, var(--color-actionListItem-default-hover-border, transparent))",
            "activeBg": "var(undefined, var(--color-actionListItem-default-active-bg, rgba(144,157,171,0.2)))",
            "activeBorder": "var(undefined, var(--color-actionListItem-default-active-border, transparent))",
            "selectedBg": "var(undefined, var(--color-actionListItem-default-selected-bg, rgba(144,157,171,0.08)))"
        },
        "danger": {
            "hoverBg": "var(undefined, var(--color-actionListItem-default-danger-hover-bg, rgba(229,83,75,0.16)))",
            "activeBg": "var(undefined, var(--color-actionListItem-default-danger-active-bg, rgba(229,83,75,0.24)))",
            "hoverText": "var(undefined, var(--color-actionListItem-default-danger-hover-text, #f47067))"
        }
    },
    "switchTrack": {
        ...
        "checked": {
            "bg": "var(undefined, var(--color-switchTrack-checked-bg, rgba(49,109,202,0.35)))",
            "hoverBg": "var(undefined, var(--color-switchTrack-checked-hover-bg, rgba(49,109,202,0.5)))",
            "activeBg": "var(undefined, var(--color-switchTrack-checked-active-bg, rgba(49,109,202,0.65)))",
            ...
            "disabledFg": "var(undefined, var(--color-switchTrack-checked-disabled-fg, #1c2128))",
    ...
    "switchKnob": {
        ...
        "checked": {
            ...
            "border": "var(undefined, var(--color-switchKnob-checked-border, rgba(49,109,202,0.35)))"
        }
    },
    "segmentedControl": {
        ...
        "button": {
            ...
            "hover": {
                "bg": "var(undefined, var(--color-segmentedControl-button-hover-bg, #444c56))"
            },
            "active": {
                "bg": "var(undefined, var(--color-segmentedControl-button-hover-active-bg, #373e47))"
            },
            "selected": {
                "border": "var(undefined, var(--color-segmentedControl-button-hover-active-selected-border, #636e7b))"
            }
        }
    },
    "treeViewItem": {
        "chevron": {
            "hoverBg": "var(undefined, var(--color-treeViewItem-chevron-hover-bg, rgba(144,157,171,0.12)))"
        },
        "directory": {
