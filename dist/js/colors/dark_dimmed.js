...
exports.default = {
    ...
    "marketingIcon": {
        "primary": "var(undefined, var(--color-marketing-icon-primary, #6cb6ff))",
        "secondary": "var(undefined, var(--color-marketing-icon-secondary, #316dca))"
    },
    "diffBlob": {
        "addition": {
        ...
        "deletion": {
            ...
            "numBg": "var(undefined, var(--color-diff-blob-addition-deletion-num-bg, rgba(229,83,75,0.3)))",
            "lineBg": "var(undefined, var(--color-diff-blob-addition-deletion-line-bg, (theme) => `var(--bgColor-danger-muted, var(--color-danger-subtle, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.red.4'), 0.1)(theme)}))`))",
            "wordBg": "var(undefined, var(--color-diff-blob-addition-deletion-word-bg, (theme) => `var(--borderColor-danger-muted, var(--color-danger-muted, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.red.4'), 0.4)(theme)}))`))"
        },
        "hunk": {
            "numBg": "var(undefined, var(--color-diff-blob-addition-deletion-hunk-num-bg, (theme) => `var(--borderColor-accent-muted, var(--color-accent-muted, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.blue.4'), 0.4)(theme)}))`))"
        },
        "expander": {
            "icon": "#adbac7"
        },
        "selectedLineHighlightMixBlendMode": "var(undefined, var(--color-diff-blob-addition-deletion-hunk-expander-selected-line-highlight-mix-blend-mode, screen))"
    },
    "diffstat": {
    ...
    "prettylights": {
        "syntax": {
            "comment": "var(undefined, var(--color-prettylights-syntax-comment, #768390))",
            "constant": "var(undefined, var(--color-prettylights-syntax-constant, #6cb6ff))",
            "entity": "var(undefined, var(--color-prettylights-syntax-entity, #dcbdfb))",
            "storageModifierImport": "var(undefined, var(--color-prettylights-syntax-storage-modifier-import, #adbac7))",
            "entityTag": "var(undefined, var(--color-prettylights-syntax-entity-tag, #8ddb8c))",
            "keyword": "var(undefined, var(--color-prettylights-syntax-keyword, #f47067))",
            "string": "var(undefined, var(--color-prettylights-syntax-string, #96d0ff))",
            "variable": "var(undefined, var(--color-prettylights-syntax-variable, #f69d50))",
            "brackethighlighterUnmatched": "var(undefined, var(--color-prettylights-syntax-brackethighlighter-unmatched, #e5534b))",
            "invalidIllegalText": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-text, #cdd9e5))",
            "invalidIllegalBg": "var(undefined, var(--color-prettylights-syntax-invalid-illegal-bg, #922323))",
            "carriageReturnText": "var(undefined, var(--color-prettylights-syntax-carriage-return-text, #cdd9e5))",
            "carriageReturnBg": "var(undefined, var(--color-prettylights-syntax-carriage-return-bg, #ad2e2c))",
            "stringRegexp": "var(undefined, var(--color-prettylights-syntax-string-regexp, #8ddb8c))",
            "markupList": "var(undefined, var(--color-prettylights-syntax-markup-list, #eac55f))",
            "markupHeading": "var(undefined, var(--color-prettylights-syntax-markup-heading, #316dca))",
            "markupItalic": "var(undefined, var(--color-prettylights-syntax-markup-italic, #adbac7))",
            "markupBold": "var(undefined, var(--color-prettylights-syntax-markup-bold, #adbac7))",
            "markupDeletedText": "var(undefined, var(--color-prettylights-syntax-markup-deleted-text, #ffd8d3))",
            "markupDeletedBg": "var(undefined, var(--color-prettylights-syntax-markup-deleted-bg, #78191b))",
            "markupInsertedText": "var(undefined, var(--color-prettylights-syntax-markup-inserted-text, #b4f1b4))",
            "markupInsertedBg": "var(undefined, var(--color-prettylights-syntax-markup-inserted-bg, #1b4721))",
            "markupChangedText": "var(undefined, var(--color-prettylights-syntax-markup-changed-text, #ffddb0))",
            "markupChangedBg": "var(undefined, var(--color-prettylights-syntax-markup-changed-bg, #682d0f))",
            "markupIgnoredText": "var(undefined, var(--color-prettylights-syntax-markup-ignored-text, #adbac7))",
            "markupIgnoredBg": "var(undefined, var(--color-prettylights-syntax-markup-ignored-bg, #255ab2))",
            "metaDiffRange": "var(undefined, var(--color-prettylights-syntax-meta-diff-range, #dcbdfb))",
            "brackethighlighterAngle": "var(undefined, var(--color-prettylights-syntax-brackethighlighter-angle, #768390))",
            "sublimelinterGutterMark": "var(undefined, var(--color-prettylights-syntax-sublimelinter-gutter-mark, #545d68))",
            "constantOtherReferenceLink": "var(undefined, var(--color-prettylights-syntax-constant-other-reference-link, #96d0ff))"
        }
    },
    "codemirror": {
    ...
    "checks": {
        ...
        "ansi": {
            "black": "var(undefined, var(--color-checks-ansi-black, #22272e))",
            "blackBright": "var(undefined, var(--color-checks-ansi-black-bright, #2d333b))",
            "white": "var(undefined, var(--color-checks-ansi-white, #909dab))",
            "whiteBright": "var(undefined, var(--color-checks-ansi-white-bright, #909dab))",
            "gray": "var(undefined, var(--color-checks-ansi-gray, #636e7b))",
            "red": "var(undefined, var(--color-checks-ansi-red, #f47067))",
            "redBright": "var(undefined, var(--color-checks-ansi-red-bright, #ff938a))",
            "green": "var(undefined, var(--color-checks-ansi-green, #57ab5a))",
            "greenBright": "var(undefined, var(--color-checks-ansi-green-bright, #6bc46d))",
            "yellow": "var(undefined, var(--color-checks-ansi-yellow, #c69026))",
            "yellowBright": "var(undefined, var(--color-checks-ansi-yellow-bright, #daaa3f))",
            "blue": "var(undefined, var(--color-checks-ansi-blue, #539bf5))",
            "blueBright": "var(undefined, var(--color-checks-ansi-blue-bright, #6cb6ff))",
            "magenta": "var(undefined, var(--color-checks-ansi-magenta, #b083f0))",
            "magentaBright": "var(undefined, var(--color-checks-ansi-magenta-bright, #dcbdfb))",
    ...
    "control": {
        "borderColor": {
            "emphasis": "var(undefined, var(--color-control-border-color-emphasis, #606771))"
        }
    },
    "avatar": {
    ...
    "selectMenu": {
        ...
        "tapHighlight": "var(undefined, var(--color-select-menu-tap-highlight, rgba(68,76,86,0.5)))",
    ...
    "btn": {
        ...
        "outline": {
            "text": "var(undefined, var(--color-btn-primary-outline-text, #4184e4))",
            "hoverText": "var(undefined, var(--color-btn-primary-outline-hover-text, #539bf5))",
            "hoverBg": "var(undefined, var(--color-btn-primary-outline-hover-bg, #444c56))",
            ...
            "hoverShadow": "var(undefined, var(--color-btn-primary-outline-hover-shadow, 0 1px 0 rgba(28,33,40,0.1)))// HI_KATIE: no matches",
            "hoverInsetShadow": "var(undefined, var(--color-btn-primary-outline-hover-inset-shadow, inset 0 1px 0 rgba(205,217,229,0.03)))// HI_KATIE: no matches",
            "hoverCounterBg": "var(undefined, var(--color-btn-primary-outline-hover-counter-bg, rgba(15,45,92,0.2)))",
            "selectedText": "var(undefined, var(--color-btn-primary-outline-selected-text, #cdd9e5))",
            "selectedBg": "var(undefined, var(--color-btn-primary-outline-selected-bg, #1b4b91))",
            ...
            "disabledText": "var(undefined, var(--color-btn-primary-outline-disabled-text, rgba(83,155,245,0.5)))",
            "disabledBg": "var(undefined, var(--color-btn-primary-outline-disabled-bg, #22272e))",
            "disabledCounterBg": "var(undefined, var(--color-btn-primary-outline-disabled-counter-bg, rgba(49,109,202,0.05)))",
            "counterBg": "var(undefined, var(--color-btn-primary-outline-counter-bg, rgba(15,45,92,0.2)))",
            "hoverCounterFg": "var(undefined, var(--color-btn-primary-outline-hover-counter-fg, #539bf5))",
            "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-disabled-counter-fg, rgba(83,155,245,0.5)))",
            "counterFg": "var(undefined, var(--color-btn-primary-outline-counter-fg, #4184e4))"
        },
        "danger": {
            "text": "var(undefined, var(--color-btn-primary-outline-danger-text, #e5534b))",
            ...
            "hoverBg": "var(undefined, var(--color-btn-primary-outline-danger-hover-bg, #c93c37))",
            "hoverBorder": "var(undefined, var(--color-btn-primary-outline-danger-hover-border, #e5534b))",
            ...
            "selectedBg": "var(undefined, var(--color-btn-primary-outline-danger-selected-bg, #ad2e2c))",
            "selectedBorder": "var(undefined, var(--color-btn-primary-outline-danger-selected-border, #f47067))",
            "selectedShadow": "var(undefined, var(--color-btn-primary-outline-danger-selected-shadow, 0 0 transparent))",
            "disabledText": "var(undefined, var(--color-btn-primary-outline-danger-disabled-text, rgba(229,83,75,0.5)))",
            "disabledBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-bg, #22272e))",
            "disabledCounterBg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-bg, rgba(201,60,55,0.05)))",
            "counterBg": "var(undefined, var(--color-btn-primary-outline-danger-counter-bg, rgba(93,15,18,0.2)))",
            "icon": "var(undefined, var(--color-btn-primary-outline-danger-icon, #e5534b))",
            ...
            "disabledCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-disabled-counter-fg, var(--control-danger-fgColor-rest, var(--color-danger-fg, rgba(229,83,75,0.5)))))",
            "hoverCounterFg": "var(undefined, var(--color-btn-primary-outline-danger-hover-counter-fg, #cdd9e5))"
        },
        "inactive": {
            "bg": "var(undefined, var(--color-btn-primary-outline-danger-inactive-bg, #373e47))",
            "text": "var(undefined, var(--color-btn-primary-outline-danger-inactive-text, #768390))"
        }
    },
    "underlinenav": {
    ...
    "actionListItem": {
        "inlineDivider": "var(undefined, var(--color-action-list-item-inline-divider, var(--borderColor-default, var(--color-border-default, rgba(68,76,86,0.48)))))",
        "default": {
            ...
            "selectedBg": "var(--control-transparent-bgColor-disabled, var(--color-action-list-item-default-selected-bg, rgba(144,157,171,0.08)))"
        },
        "danger": {
            "hoverBg": "var(undefined, var(--color-action-list-item-default-danger-hover-bg, rgba(229,83,75,0.16)))",
            "activeBg": "var(undefined, var(--color-action-list-item-default-danger-active-bg, rgba(229,83,75,0.24)))",
            "hoverText": "var(undefined, var(--color-action-list-item-default-danger-hover-text, #f47067))"
        }
    },
    "switchTrack": {
        ...
        "activeBg": "var(--controlTrack-bgColor-active, var(--color-switch-track-active-bg, (theme, HI_KATIE) => `var(--bgColor-disabled, var(--color-neutral-muted, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.gray.4'), 0.4)(theme)}))`))",
        "disabledBg": "var(--control-checked-bgColor-disabled, var(--color-switch-track-disabled-bg, #373e47))",
    ...
    "switchKnob": {
        ...
        "border": "var(--control-borderColor-emphasis, var(--color-switch-knob-border, #606771))",
        "disabledBg": "var(undefined, var(--color-switch-knob-disabled-bg, (theme) => `var(--bgColor-muted, var(--color-canvas-subtle, ${(0, utils_v1_1.get)('scale.gray.8')(theme)}))`))",
        "checked": {
            ...
            "disabledBg": "var(undefined, var(--color-switch-knob-checked-disabled-bg, (theme) => `var(--bgColor-muted, var(--color-canvas-subtle, ${(0, utils_v1_1.get)('scale.gray.8')(theme)}))`))",
            "border": "var(--controlKnob-borderColor-checked, var(--color-switch-knob-checked-border, rgba(49,109,202,0.35)))"
        }
    },
    "segmentedControl": {
        "bg": "var(undefined, var(--color-segmented-control-bg, (theme) => `var(--bgColor-neutral-muted, var(--color-neutral-subtle, ${(0, utils_v1_1.alpha)((0, utils_v1_1.get)('scale.gray.4'), 0.1)(theme)}))`))",
        "button": {
            "bg": "var(undefined, var(--color-segmented-control-button-bg, (theme) => `var(--bgColor-default, var(--color-canvas-default, ${(0, utils_v1_1.get)('scale.gray.9')(theme)}))`))",
            "hover": {
                "bg": "var(undefined, var(--color-segmented-control-button-hover-bg, #444c56))"
            },
            "active": {
                "bg": "var(undefined, var(--color-segmented-control-button-hover-active-bg, #373e47))"
            },
            "selected": {
                "border": "var(undefined, var(--color-segmented-control-button-hover-active-selected-border, #636e7b))"
            }
        }
    },
    "treeViewItem": {
        "chevron": {
            "hoverBg": "var(undefined, var(--color-tree-view-item-chevron-hover-bg, rgba(144,157,171,0.12)))"
        },
        "directory": {
            "fill": "var(undefined, var(--color-tree-view-item-chevron-directory-fill, (obj) => (0, get_1.default)(obj, path)))"
        }
    },
    "fg": {
        "default": "#adbac7",
    ...
    "primer": {
        "fg": {
            "disabled": "var(--control-fgColor-disabled, var(--color-primer-fg-disabled, #545d68))"
        },
        "canvas": {
            "backdrop": "var(undefined, var(--color-primer-fg-canvas-backdrop, rgba(28,33,40,0.8)))",
            "sticky": "var(undefined, var(--color-primer-fg-canvas-sticky, rgba(34,39,46,0.95)))"
        },
        "border": {
            "active": "var(undefined, var(--color-primer-fg-canvas-border-active, #ec775c))",
            "contrast": "var(undefined, var(--color-primer-fg-canvas-border-contrast, rgba(205,217,229,0.2)))"
        },
        "shadow": {
