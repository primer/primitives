...
exports.default = {
    ...
    "diffBlob": {
        "addition": {
            "numText": "var(--diffBlob-addition-fgColor-num, var(--color-diff-blob-addition-num-text, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
            "fg": "var(--diffBlob-addition-fgColor-text, var(--color-diff-blob-addition-fg, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
        ...
        "deletion": {
            "numText": "var(undefined, var(--color-diff-blob-addition-deletion-num-text, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
            "fg": "var(undefined, var(--color-diff-blob-addition-deletion-fg, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
        ...
        "expander": {
            "icon": "var(undefined, var(--color-diff-blob-addition-deletion-hunk-expander-icon, var(--control-iconColor-rest, var(--color-fg-muted, #848d97))))"
        },
    ...
    "switchTrack": {
        ...
        "fg": "var(--controlTrack-fgColor-rest, var(--color-switch-track-fg, var(--control-iconColor-rest, var(--color-fg-muted, #848d97))))",
    ...
    "treeViewItem": {
        ...
        "directory": {
            "fill": "var(undefined, var(--color-tree-view-item-chevron-directory-fill, var(--control-iconColor-rest, var(--color-fg-muted, #848d97))))"
        }
    },
    "fg": {
