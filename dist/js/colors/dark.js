...
exports.default = {
    ...
    "diffBlob": {
        "addition": {
            "numText": "var(undefined, var(--color-addition-num-text, #e6edf3))",
            "fg": "var(undefined, var(--color-addition-fg, #e6edf3))",
            "numBg": "var(undefined, var(--color-addition-num-bg, rgba(63,185,80,0.3)))",
        ...
        "deletion": {
            "numText": "var(undefined, var(--color-deletion-num-text, #e6edf3))",
            "fg": "var(undefined, var(--color-deletion-fg, #e6edf3))",
        ...
        "expander": {
            "icon": "var(undefined, var(--color-expander-icon, #848d97))"
        },
    ...
    "prettylights": {
        "syntax": {
            ...
            "entityTag": "var(undefined, var(--color-syntax-entity-tag, #7ee787))",
            "keyword": "var(undefined, var(--color-syntax-keyword, #ff7b72))",
            "string": "var(undefined, var(--color-syntax-string, #a5d6ff))",
            "variable": "var(undefined, var(--color-syntax-variable, #ffa657))",
            ...
            "stringRegexp": "var(undefined, var(--color-syntax-string-regexp, #7ee787))",
            ...
            "markupInsertedText": "var(undefined, var(--color-syntax-markup-inserted-text, #aff5b4))",
            "markupInsertedBg": "var(undefined, var(--color-syntax-markup-inserted-bg, #033a16))",
            "markupChangedText": "var(undefined, var(--color-syntax-markup-changed-text, #ffdfb6))",
            "markupChangedBg": "var(undefined, var(--color-syntax-markup-changed-bg, #5a1e02))",
    ...
    "checks": {
        ...
        "textPrimary": "var(undefined, var(--color-checks-text-primary, #e6edf3))",
        "textSecondary": "var(undefined, var(--color-checks-text-secondary, #848d97))",
        "textLink": "var(undefined, var(--color-checks-text-link, #2f81f7))",
        "btnIcon": "var(undefined, var(--color-checks-btn-icon, #848d97))",
        "btnHoverIcon": "var(undefined, var(--color-checks-btn-hover-icon, #e6edf3))",
        "btnHoverBg": "var(undefined, var(--color-checks-btn-hover-bg, (obj) => {\n        const resolvedValue = resolveValue(value, obj);\n        // Instead of value being #hex, the value is now var(--v, #hex)\n        const hexColorValue = getFallbackValueFromVar(resolvedValue);\n        const hexColorValueWithTransparency = (0, color2k_1.transparentize)(hexColorValue, 1 - amount).replace(/ /g, '');\n        return resolvedValue.replace(hexColorValue, hexColorValueWithTransparency);\n    }))",
        "inputText": "var(undefined, var(--color-checks-input-text, #848d97))",
        "inputPlaceholderText": "var(undefined, var(--color-checks-input-placeholder-text, (obj) => (0, get_1.default)(obj, path)))",
        "inputFocusText": "var(undefined, var(--color-checks-input-focus-text, #e6edf3))",
        ...
        "dropdownText": "var(undefined, var(--color-checks-dropdown-text, #e6edf3))",
        ...
        "dropdownHoverText": "var(undefined, var(--color-checks-dropdown-hover-text, #e6edf3))",
        "dropdownHoverBg": "var(undefined, var(--color-checks-dropdown-hover-bg, (obj) => {\n        const resolvedValue = resolveValue(value, obj);\n        // Instead of value being #hex, the value is now var(--v, #hex)\n        const hexColorValue = getFallbackValueFromVar(resolvedValue);\n        const hexColorValueWithTransparency = (0, color2k_1.transparentize)(hexColorValue, 1 - amount).replace(/ /g, '');\n        return resolvedValue.replace(hexColorValue, hexColorValueWithTransparency);\n    }))",
        "dropdownBtnHoverText": "var(undefined, var(--color-checks-dropdown-btn-hover-text, #e6edf3))",
        ...
        "headerLabelText": "var(undefined, var(--color-checks-header-label-text, #848d97))",
        "headerLabelOpenText": "var(undefined, var(--color-checks-header-label-open-text, #e6edf3))",
        "headerBorder": "var(undefined, var(--color-checks-header-border, (obj) => (0, get_1.default)(obj, path)))",
        "headerIcon": "var(undefined, var(--color-checks-header-icon, #848d97))",
        "lineText": "var(undefined, var(--color-checks-line-text, #848d97))",
        ...
        "lineSelectedNumText": "var(undefined, var(--color-checks-line-selected-num-text, #2f81f7))",
        ...
        "gateText": "var(undefined, var(--color-checks-gate-text, #848d97))",
        ...
        "loglineText": "var(undefined, var(--color-checks-logline-text, #848d97))",
        ...
        "loglineErrorText": "var(undefined, var(--color-checks-logline-error-text, #848d97))",
        ...
        "loglineWarningText": "var(undefined, var(--color-checks-logline-warning-text, #848d97))",
        ...
        "loglineCommandText": "var(undefined, var(--color-checks-logline-command-text, #2f81f7))",
    ...
    "btn": {
        ...
        "primary": {
            ...
            "bg": "var(undefined, var(--color-primary-bg, #238636))",
            ...
            "hoverBg": "var(undefined, var(--color-primary-hover-bg, #2ea043))",
            "hoverBorder": "var(undefined, var(--color-primary-hover-border, (obj) => {\n        const resolvedValue = resolveValue(value, obj);\n        // Instead of value being #hex, the value is now var(--v, #hex)\n        const hexColorValue = getFallbackValueFromVar(resolvedValue);\n        const hexColorValueWithTransparency = (0, color2k_1.transparentize)(hexColorValue, 1 - amount).replace(/ /g, '');\n        return resolvedValue.replace(hexColorValue, hexColorValueWithTransparency);\n    }))",
            "selectedBg": "var(undefined, var(--color-primary-selected-bg, #238636))",
            ...
            "disabledBg": "var(undefined, var(--color-primary-disabled-bg, rgba(35,134,54,0.6)))",
            "disabledBorder": "var(undefined, var(--color-primary-disabled-border, (obj) => {\n        const resolvedValue = resolveValue(value, obj);\n        // Instead of value being #hex, the value is now var(--v, #hex)\n        const hexColorValue = getFallbackValueFromVar(resolvedValue);\n        const hexColorValueWithTransparency = (0, color2k_1.transparentize)(hexColorValue, 1 - amount).replace(/ /g, '');\n        return resolvedValue.replace(hexColorValue, hexColorValueWithTransparency);\n    }))",
            "icon": "var(undefined, var(--color-primary-icon, #ffffff))",
            "counterBg": "var(undefined, var(--color-primary-counter-bg, rgba(4,38,15,0.2)))"
        },
        "outline": {
            ...
            "disabledCounterFg": "var(undefined, var(--color-outline-disabled-counter-fg, rgba(47,129,247,0.5)))",
    ...
    "switchTrack": {
        ...
        "fg": "var(undefined, var(--color-switchTrack-fg, #848d97))",
    ...
    "treeViewItem": {
        ...
        "directory": {
            "fill": "var(undefined, var(--color-directory-fill, #848d97))"
        }
    },
    "fg": {
        "default": "#e6edf3",
