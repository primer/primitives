...
exports.default = {
    ...
    "diffBlob": {
        "addition": {
            "numText": "var(undefined, var(--color-addition-num-text, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
            "fg": "var(undefined, var(--color-addition-fg, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
        ...
        "deletion": {
            "numText": "var(undefined, var(--color-deletion-num-text, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
            "fg": "var(undefined, var(--color-deletion-fg, var(--control-fgColor-rest, var(--color-fg-default, #e6edf3))))",
        ...
        "expander": {
            "icon": "var(undefined, var(--color-expander-icon, var(--control-iconColor-rest, var(--color-fg-muted, #848d97))))"
        },
    ...
    "btn": {
        ...
        "outline": {
            ...
            "disabledCounterFg": "var(undefined, var(--color-outline-disabled-counter-fg, var(--focus-outlineColor, var(--color-accent-fg, rgba(47,129,247,0.5)))))",
    ...
    "treeViewItem": {
        ...
        "directory": {
            "fill": "var(undefined, var(--color-directory-fill, var(--control-iconColor-rest, var(--color-fg-muted, #848d97))))"
        }
    },
    "fg": {
